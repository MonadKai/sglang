...
from transformers.models.parrot_audio.modeling_parrot_audio import ParrotAudioMultiModalProjector
...
class ParrotAudioForConditionalGeneration(nn.Module):
...
EntryClass = ParrotAudioForConditionalGeneration
